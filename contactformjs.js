...
$(document).ready(function()
{
    	$("button").click(function()
    	{
        	 ...
        	 $("#checkSubValue1:checked").each(function() //check box values1
			 {
  				  data.sSubjChkValue1=$(this).val();
			 });
			 $("#checkSubValue2:checked").each(function() //check box values2
			 {
  				  data.sSubjChkValue2=$(this).val();
			 });		
			 $("#checkSubValue3:checked").each(function() //check box values3
			 {
